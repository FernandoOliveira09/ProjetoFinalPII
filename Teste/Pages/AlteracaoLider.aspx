<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AlteracaoLider.aspx.cs" Inherits="ProjetoFinal.Web.Pages.AlteracaoLider" %>
                        ...
                        <form class="col s12" runat="server">
                          ...
                          <div class="row">
                            <div class="input-field col s12">
                              <asp:TextBox id="TxtNome" type="text" runat="server" Enabled="false" />
                              <label for="TxtNome">Lider atual</label>
                            </div>
                          </div>

                          <div class="row">
                            <div class="input-field col s6">
                              <asp:TextBox id="TxtDataEntrada" type="text" runat="server" Enabled="false" ClientIDMode="Static" />
                          ...
                          <div class="row">
                            <div class="input-field col s6">
                              <asp:TextBox id="TxtDataSaida" type="text" runat="server" ClientIDMode="Static" />
                              <label for="TxtDataSaida">Data de saída<span style="color: red;">*</span></label>
                            </div>
                          </div>  
                          ...
                          <div class="row">
                            <div class="input-field col s12">
                              <asp:Label id="LblResultado" type="text" ForeColor="Red" runat="server" />
                            </div>
                          </div>
                        </form>
                      </div>
