           ...
           <div class='row'>
            ...
            <center>
              <div class='row' align="center">
                <asp:LinkButton type='submit' name='btncadastrar' class='col s12 btn btn-large waves-effect blue darken-4' runat="server" Text="Alterar" style="text-align:center" OnClick="BtnAlterar_Click"></asp:LinkButton>
              </div>
            </center>
          </form>
        </div>
