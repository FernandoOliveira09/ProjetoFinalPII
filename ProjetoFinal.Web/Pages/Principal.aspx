<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Principal.aspx.cs" Inherits="ProjetoFinal.Web.Pages.Admin" %>
...
<html lang="pt-br">
  ...
  <head>
    ...
    <!-- Favicons-->
    <link rel="apple-touch-icon-precomposed" href="../Conten/images/favicon/apple-touch-icon-152x152.png">
    <!-- For iPhone -->
                ...
                <div class="col s12 m4 l4">
                  <div id="profile-card" class="card">
                    <div class="card-image waves-effect waves-block waves-light">
                      <img class="activator" src="../Content/images/gallary/3.png" alt="user bg">
                    </div>
                    <div class="card-content">
                      <img src="../Content/images/avatar/avatar-7.png" alt="" class="circle responsive-img activator card-profile-image cyan lighten-1 padding-2">
