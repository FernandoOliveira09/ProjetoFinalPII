                                ...
                                <div class="card-panel">
                                    ...
                                    <div class="row">
                                        <form class="col s12" runat="server">
                                            ...
                                            <div class="row">
                                                <div class="input-field col s12">
                                                    <asp:Button ID="BtnAlterar" class="btn waves-effect waves-light right teal lighten-2" type="submit" name="action" Text="Alterar" runat="server" OnClick="BtnAlterar_Click1"></asp:Button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
