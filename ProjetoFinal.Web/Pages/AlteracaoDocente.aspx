<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AlteracaoDocente.aspx.cs" Inherits="ProjetoFinal.Web.Pages.AlteracaoDocente" %>
          ...
          <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="no-padding">
              <ul class="collapsible" data-collapsible="accordion">
                ...
                <li class="bold">
                  <a href="ConsultaDocente.aspx" class="waves-effect waves-cyan">
                      <i class="material-icons">group_work</i>
              ...
              <div class="container">
                <div class="row">
                  <div class="col s10 m6 l6">
                    <h5 class="breadcrumbs-title">Alteração de Docente</h5>
                    <ol class="breadcrumbs">
                      <li><a href="index.html">Dashboard</a></li>
                      <li><a href="#">Docentes</a></li>
                      <li><a href="#">Alteração de Docente</a></li>
                    </ol>
                  </div>
                </div>
              </div>
                        ...
                        <form class="col s12" runat="server">
                          ...
                          <div class="row">
                            <div class="input-field col s6">
                              ...
                              <label for="TxtData">Data de entrada no grupo<span style="color: red;">*</span></label>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="input-field col s12">
                              <label for="FUFoto">Foto do docente<span style="color: red;">*</span></label>
                                <br />
                                <br />
                          ...
                          <div class="row">
                              <div class="input-field col s12">
                                  <asp:Button id="BtnAlterar" class="btn waves-effect waves-light right teal lighten-2" type="submit" name="action" Text="Alterar" runat="server" OnClick="BtnAlterar_Click1">
                                  </asp:Button>
                              </div>
                          </div>
                        </form>
