<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CadastroEquipamento.aspx.cs" Inherits="ProjetoFinal.Web.Pages.CadastroEquipamento" %>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col s10 m6 l6">
                                    <h5 class="breadcrumbs-title">Cadastro de Equipamentos</h5>
                                        ...
                                        <form class="col s12" runat="server">
                                            <div class="row">
                                                <div class="input-field col s12">
                                                    ...
                                                    <label for="TxtNome">Nome do Equipamento<span style="color: red;">*</span></label>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="input-field col s12">
