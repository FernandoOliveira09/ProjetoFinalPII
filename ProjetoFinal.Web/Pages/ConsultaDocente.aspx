<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsultaDocente.aspx.cs" Inherits="ProjetoFinal.Web.Pages.ConsultaDocente" %>
              ...
              <div class="container">
                <div class="row">
                  <div class="col s10 m6 l6">
                    <h5 class="breadcrumbs-title">Consulta de Docentes</h5>
                    ...
                    <asp:Repeater ID="RptConsulta" runat="server">
                        ...
                        <ItemTemplate>
                             <tr>
                                <td><%# Eval("Nome") %></td>
                                <td><%# Eval("Formacao") %></td>
                                <td><%# Eval("DataInclusao") %></td>
                                <td><%# Eval("Lattes") %></td>
                                <td><a class="btn waves-effect waves-light teal lighten-2" href="../Pages/AlteracaoDocente.aspx?docente=<%# Eval("IdDocente") %>"><i class="material-icons">edit</i></a></td>
