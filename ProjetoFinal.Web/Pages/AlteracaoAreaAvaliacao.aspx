<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AlteracaoAreaAvaliacao.aspx.cs" Inherits="ProjetoFinal.Web.Pages.AlteracaoAreaAvaliacao" %>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col s10 m6 l6">
                                    <h5 class="breadcrumbs-title">Alteração de área de avaliação</h5>
                                    <ol class="breadcrumbs">
                                        <li><a href="../Pages/Principal.aspx">Dashboard</a></li>
                                        <li><a href="#">Linhas de pesquisa</a></li>
                                        <li><a href="#">Alteração de área de avaliação</a></li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-panel">
                                    ...
                                    <div class="row">
                                        <form class="col s12" runat="server">
                                            ...
                                            <div class="row">
                                                <div class="row">
                                                    <div class="input-field col s6">
                                                        <asp:TextBox ID="TxtConhecimento" type="text" runat="server" Enabled="false" />
                                                        <label for="TxtConhecimento">Área do conhecimento atual <span style="color: red;">*</span></label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="input-field col s6">
                                                    <asp:TextBox ID="TxtIdAva" type="text" runat="server" MaxLength="10" />
                                                    <label for="TxtIdAva">Código da área de avaliação <span style="color: red;">*</span></label>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="input-field col s6">
                                                    <asp:TextBox ID="TxtAreaAvaliacao" type="text" runat="server" />
                                                    <label for="TxtAreaAvaliacao">Nome <span style="color: red;">*</span></label>
                                                </div>
                                            </div>
