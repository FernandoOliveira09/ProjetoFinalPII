<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsultaAreaConhecimento.aspx.cs" Inherits="ProjetoFinal.Web.Pages.ConsultaAreaAvaliacao" %>
              ...
              <div class="container">
                <div class="row">
                  <div class="col s10 m6 l6">
                    ...
                    <h5 class="breadcrumbs-title">Consulta de área do conhecimento</h5>
                    <ol class="breadcrumbs">
                      <li><a href="../Pages/Principal.aspx">Dashboard</a></li>
                      <li><a href="#">Grupos de Pesquisa</a></li>
                      <li><a href="#">Consulta de área do conhecimento</a></li>
                    </ol>
                  </div>
                  <div class="col s2 m6 l6">
                     <a class="btn waves-effect waves-light breadcrumbs-btn right teal lighten-2" href="../Pages/CadastroAreaConhecimento.aspx">Nova Área</a>
                  </div>
                </div>
              </div>
            </div>
                    ...
                    <asp:Repeater ID="RptConsulta" runat="server">
                        ...
                        <ItemTemplate>
                             <tr>
                                ...
                                <td><%# Eval("Nome") %></td>
                                <%--<td><%# Eval("Status") %></td>--%>
                                <td><a class="btn waves-effect waves-light teal lighten-2" href="../Pages/AlteracaoAreaConhecimento.aspx?id=<%# Eval("ID") %>"><i class="material-icons">edit</i>&nbsp&nbsp<a class="btn waves-effect waves-light teal lighten-2" href="../Pages/Alteracaolider.aspx?linha=<%# Eval("ID") %>"><i class="material-icons">close</i></a></a></td>
