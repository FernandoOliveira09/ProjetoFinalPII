<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AlteracaoLinhaPesquisa.aspx.cs" Inherits="ProjetoFinal.Web.Pages.AlteracaoLinhaPesquisa" %>
                                        ...
                                        <form class="col s12" runat="server">
                                            <div class="row">
                                                <div class="input-field col s6">
                                                    <asp:TextBox ID="TxtSubArea" type="text" runat="server" Enabled="false" />
                                                    <label for="TxtIdLinha">Sub área <span style="color: red;">*</span></label>
                                                </div>
                                            </div>
                                            <asp:CheckBox ID="TxtSelecao" Text="Alterar área do conhecimento" runat="server" AutoPostBack="true" OnCheckedChanged="TxtSelecao_CheckedChanged" />
                                            <div class="row">
                                                <div class="input-field col s10">
                                                    <label for="TxtAreaConhecimento">Selecione a área de conhecimento<span style="color: red;">*</span></label>
                                                    <br />
                                                    <asp:DropDownList class="input-field" runat="server" ID="TxtAreaConhecimento" AutoPostBack="true" OnSelectedIndexChanged="TxtAreaConhecimento_SelectedIndexChanged" Enabled="false">
                                                    </asp:DropDownList>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="input-field col s8">
                                                    ...
                                                    <br />
                                                    <asp:DropDownList class="input-field" runat="server" ID="TxtAreaAvaliacao" AutoPostBack="true" Enabled="false" OnSelectedIndexChanged="TxtAreaAvaliacao_SelectedIndexChanged">
                                                    </asp:DropDownList>
                                            ...
                                            <div class="row">
                                                <div class="input-field col s8" style="float: left">
                                                    ...
                                                    <br />
                                                    <asp:DropDownList class="input-field" runat="server" ID="TxtSubAreaAvaliacao" Enabled="false">
                                                    </asp:DropDownList>
