                         ...
                         <div class="row">
                            <div class='input-field col s12'>
                                ...
                                <asp:Repeater ID="RptDocente" runat="server">
                                    ...
                                    <ItemTemplate>
                                         <tr>
                                            <td><asp:Label ID="TxtNomeDocente" Text='<%# Eval("Nome") %>' runat="server"></asp:Label> </td>
                                            <%--<td><%# Eval("Status") %></td>--%>
                                            <td><asp:LinkButton ID="BtnAddDocente" class="btn waves-effect waves-light breadcrumbs-btn right teal lighten-2" runat="server" Text="+" OnClick="BtnAddDocente_Click"></asp:LinkButton></td>
                                    ...
                                    <ItemTemplate>
                                         <tr>
                                            <td><asp:Label ID="TxtNomeGrupo" Text='<%# Eval("Nome") %>' runat="server"></asp:Label> </td>
                                             <td><asp:Label ID="TxtDataEntrada" Text='<%# Eval("Data_entrada", "{0:d}") %>' runat="server"></asp:Label> </td>
                                            <%--<td><%# Eval("Status") %></td>--%>
                                ...
                                <asp:Repeater ID="RptLinha" runat="server">
                                    ...
                                    <ItemTemplate>
                                         <tr>
                                            ...
                                            <td><asp:Label ID="TxtDataEntrada" Text='<%# Eval("Data_inicio", "{0:d}") %>' runat="server"></asp:Label> </td>
                                            <%--<td><%# Eval("Status") %></td>--%>
                                            <td><asp:LinkButton ID="BtnAddLinha" class="btn waves-effect waves-light breadcrumbs-btn right teal lighten-2" runat="server" Text="+" OnClick="BtnAddLinha_Click"></asp:LinkButton></td>
            <%--                               <td><button class="waves-effect waves-light btn teal lighten-2 BtnAlterar"><i class="material-icons">edit</i><a href="../Pages/Login.aspx"></a></button>&nbsp<button class="waves-effect waves-light btn teal lighten-2 BtnMais"><i class="material-icons">visibility</i></button></td>--%>
                                          </tr>               
                                    </ItemTemplate>
                                    <FooterTemplate>
