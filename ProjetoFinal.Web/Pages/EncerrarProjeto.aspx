<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EncerrarProjeto.aspx.cs" Inherits="ProjetoFinal.Web.Pages.EncerrarProjeto" %>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col s10 m6 l6">
                                <h5 class="breadcrumbs-title">Encerrar projeto</h5>
                                <ol class="breadcrumbs">
                                    <li><a href="../Pages/Principal.aspx">Dashboard</a></li>
                                    <li><a href="#">Projetos</a></li>
                                    <li><a href="#">Encerrar projeto</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col s12 m12 l12">
                                <div class="card-panel">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <asp:Button ID="BtnEncerrar" class="btn waves-effect waves-light right teal lighten-2" type="submit" name="action" Text="Encerrar" runat="server" OnClick="BtnEncerrar_Click"></asp:Button>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s12">
