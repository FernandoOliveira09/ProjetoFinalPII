<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VincularGrupoTecnico.aspx.cs" Inherits="ProjetoFinal.Web.Pages.VincularGrupoTecnico" %>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col s10 m6 l6">
                                    <h5 class="breadcrumbs-title">Vinculação de técnico</h5>
                                    <ol class="breadcrumbs">
                                        <li><a href="../Pages/Principal.aspx">Dashboard</a></li>
                                        <li><a href="#">Técnicos</a></li>
                                        <li><a href="#">Vinculação de técnico</a></li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <form class="col s12" runat="server">
                                            ...
                                            <div class="row">
                                                <div class="input-field col s8">
                                                    <label for="TxtTecnico">Selecione o técnico<span style="color: red;">*</span></label>
                                                    <br />
                                                    <asp:DropDownList class="input-field" runat="server" ID="TxtTecnico" AutoPostBack="true">
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="input-field col s6">
                                                    <asp:TextBox ID="TxtData" type="text" runat="server" MaxLength="10" />
                                            ...
                                            <div class="row">
                                                <div class="input-field col s12">
                                                    <asp:Button ID="BtnCadastrar" class="btn waves-effect waves-light right teal lighten-2" type="submit" name="action" Text="Vincular" runat="server" OnClick="BtnCadastrar_Click"></asp:Button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
