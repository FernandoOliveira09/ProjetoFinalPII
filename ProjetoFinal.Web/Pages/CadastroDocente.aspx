                                ...
                                <div class="card-panel">
                                    ...
                                    <div class="row">
                                        <form class="col s12" runat="server">
                                            ...
                                            <div class="row">
                                                <div class="input-field col s12">
                                                    <asp:Button ID="BtnCadastrar" class="btn waves-effect waves-light right teal lighten-2" type="submit" name="action" Text="Cadastrar" runat="server" OnClick="BtnCadastrar_Click1"></asp:Button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
